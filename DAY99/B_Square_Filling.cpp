...
void shreyu(){
    ...
    // if(arr[n-1][m-1] == 1 && brr[n-1][m-1] == 0){ // down
    //     vp.pb({n-1, m-1});
    //     brr[n-1][m-1] = 1;
    //     brr[n-2][m-1] = 1;
    //     brr[n-1][m-2] = 1;
    ...
    // if(arr[0][m-1] == 1 && brr[0][m-1] == 0){ // right
    //     vp.pb({1, m-1});
    //     // cout << 100;
    //     brr[0][m-1] = 1;
    //     brr[1][m-1] = 1;
    ...
    // if(arr[n-1][0] == 1 && brr[n-1][0] == 0){ // left down
    //     vp.pb({n-1, 1});
    //     brr[n-1][0] = 1;
    //     brr[n-2][0] = 1;
    //     brr[n-1][1] = 1;
