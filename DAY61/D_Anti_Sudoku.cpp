...
void shreyu(){
    ...
    arr[0][0]++;
    if(arr[0][0] == 10) arr[0][0] = 1;
    arr[1][3]++;
    if(arr[1][3] == 10) arr[1][3] = 1;
    arr[2][6]++;
    if(arr[2][6] == 10) arr[2][6] = 1;

    arr[3][1]++;
    if(arr[3][1] == 10) arr[3][1] = 1;
    arr[4][4]++;
    if(arr[4][4] == 10) arr[4][4] = 1;
    arr[5][7]++;
    if(arr[5][7] == 10) arr[5][7] = 1;

    arr[6][2]++;
    if(arr[6][2] == 10) arr[6][2] = 1;
    arr[7][5]++;
    if(arr[7][5] == 10) arr[7][5] = 1;
    arr[8][8]++;
    if(arr[8][8] == 10) arr[8][8] = 1;
