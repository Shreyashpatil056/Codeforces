...
//<=====================================================================>
void shreyu(){
    ll one = 0, zero = 0, two = 0, mini = INT_MAX, maxi = 0 ;
    ll odd = 0, even = 0 ;
    ll n = 0, m = 0, k = 0, c = 0;
    string s = "" , temp = "";
    cin >> s ;
    ...
    forn(i,n) {
        if(s[i] == '2' || s[i] == '1') {
            ll ii = i;
            while(i < n && s[i] == '2' || s[i] == '1') {
                if(s[i] == '2') two++;
                else one++;
                i++;
            }
            for(int j = ii; j < one + ii; j++){
                s[j] = '1';
            }
            for(int j = one + ii; j < one + two + ii; j++){
                s[j] = '2';
            }
            two = 0; one = 0;
        }
    ...
    forn(i,n) {
        if(s[i] == '0' || s[i] == '1') {
            ...
            for(int j = ii; j < zero + ii; j++){
                s[j] = '0';
            }
            for(int j = zero + ii; j < one + zero + ii; j++){
                s[j] = '1';
            }
            zero = 0; one = 0;
        }
    ...
    // forn(i,n) if(s[i] == '2') {two = i; break;}

    // //count the no of 0's after 1st 2;
    // for(int i=two; i<n; i++) {
    //     if(s[i] == '0') zero++;
    //     if(s[i] == '2') two++;
    // }
