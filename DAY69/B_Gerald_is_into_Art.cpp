...
void shreyu(){
    ...
    else if(a1>= a2+b3 && b1 >= max(b2,a3))cout << "YES\n";
    else if(a1>= b2+a3 && b1 >= max(a2,b3))cout << "YES\n";
    else if(a1>= b2+b3 && b1 >= max(a2,a3))cout << "YES\n";
    
    else if(a1>= max(a2,a3) && b1 >= b2+b3)cout << "YES\n";
    else if(a1>= max(a2,b3) && b1 >= b2+a3)cout << "YES\n";
    else if(a1>= max(b2,a3) && b1 >= a2+b3)cout << "YES\n";
    else if(a1>= max(b2,b3) && b1 >= a2+a3)cout << "YES\n";
    else cout << "NO\n"; 
}
