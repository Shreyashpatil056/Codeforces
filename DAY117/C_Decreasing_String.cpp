...
void shreyu(){
    ...
    // printv(vis);
    // c - kitne rmv karne hai
    // k - bache hue string ka kth index print karo


    // int cnt = 0;
    // char prev = s[0]; 
    // int previdx = 0;
    // for(int i=0; i+1 < n && cnt < c; i++){
    //     if(s[i] < prev){
    //         prev = s[i];
    //         cnt++;
    //         vis[previdx] = true;
...
//<=====================================================================>
// fxictuogfaecjxeseuvdydfdkbqkop
signed main()
{
   fast_cin();
   #ifndef ONLINE_JUDGE
