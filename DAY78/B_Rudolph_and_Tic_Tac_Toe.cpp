...
void shreyu() {
    ...
    // char ch = arr[0][0];
    // if ((ch == arr[0][1] && ch == arr[0][2]) || (ch == arr[1][0] && ch == arr[2][0]) || (ch == arr[1][1] && ch == arr[2][2])) {
    //     if (ch != '.') {
    //         if (ch == 'X')
    //             cout << 'X' << endl;
    //         else if (ch == 'O')
    ...
    // if ((ch == arr[1][1] && ch == arr[1][2]) || (ch == arr[0][0] && ch == arr[2][0])) {
    //     if (ch != '.') {
    //         if (ch == 'X')
    //             cout << 'X' << endl;
    //         else if (ch == 'O')
    ...
    // if (ch != '.' && ((ch == arr[2][1] && ch == arr[2][2]) || (ch == arr[0][0] && ch == arr[1][0]) || (ch == arr[1][1] && ch == arr[0][2]))) {
    //     if (ch == 'X')
    //         cout << 'X' << endl;
    //     else if (ch == 'O')
    //         cout << 'O' << endl;
    ...
    // ch = arr[0][1];
    // if (ch != '.' && ((ch == arr[1][1] && ch == arr[2][1]) || (ch == arr[0][0] && ch == arr[0][2]))) {
    //     if (ch == 'X')
    //         cout << 'X' << endl;
    //     else if (ch == 'O')
    //         cout << 'O' << endl;
