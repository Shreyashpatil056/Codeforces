...
void shreyu(){
    ...
    for(int i = 0; i < s.size() - 1; i++) {
        if(s[i] == 'A' && s[i+1] == 'B') {
            // ab1 = 1;
            // temp = s.substr(0,i) + s.substr(i+2);
            temp1 = s.substr(0,i);
            temp2 = s.substr(i+2);

            for(int j = 0; j < temp1.size() - 1; j++) {
                if(temp1[j] == 'B' && temp1[j+1] == 'A') {
                    yup;
                    return;
                }
            }
            for(int j = 0; j < temp2.size() - 1; j++) {
                if(temp2[j] == 'B' && temp2[j+1] == 'A') {
                    yup;
                    return;
                }
            }
    ...
    for(int i = 0; i < s.size() - 1; i++) {
        if(s[i] == 'B' && s[i+1] == 'A') {
            ...
            for(int j = 0; j < temp1.size() - 1; j++) {
                if(temp1[j] == 'A' && temp1[j+1] == 'B') {
                    yup;
                    return;
                }
            }
            for(int j = 0; j < temp2.size() - 1; j++) {
                if(temp2[j] == 'A' && temp2[j+1] == 'B') {
                    yup;
                    return;
                }
            }
